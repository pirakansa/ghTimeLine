...
discussions, and supported ProjectV2 items through saved queries.
...
- GraphQL ProjectV2 discovery for issue and pull request project items
...
- Project draft issue rendering, redacted items, and full project field rendering
- Additional search resource types beyond issues, pull requests, discussions,
  and supported ProjectV2 items
