...
impl GhStreamApp {
    ...
    fn refresh_now(&mut self) {
        self.status =
            "Refresh pipeline is ready; GitHub API execution is not implemented yet.".to_owned();
    }
    ...
    fn maybe_poll(&mut self) {
            ...
            .is_none_or(|last_poll_at| last_poll_at.elapsed() >= interval)
        {
            ...
            self.status =
                "Polling interval elapsed; GitHub API execution is not implemented yet.".to_owned();
        }
    }
}
