...
struct ProjectRequest<'a> {
    query: String,
    variables: ProjectVariables<'a>,
}

impl<'a> ProjectRequest<'a> {
    fn new(locator: &'a ProjectLocator, first: usize, after: Option<&'a str>) -> Self {
...
struct ProjectResponse {
    ...
    errors: Option<Vec<ProjectError>>,
}
...
impl ProjectData {
    fn project(self, locator: &ProjectLocator) -> Option<Project> {
        match locator {
